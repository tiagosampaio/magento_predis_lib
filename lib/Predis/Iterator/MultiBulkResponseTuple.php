 ...
 */
class Predis_Iterator_MultiBulkResponseTuple extends Predis_Iterator_MultiBulkResponse implements \OuterIterator
{
    private $iterator;

    /**
     * @param Predis_Iterator_MultiBulkResponseSimple $iterator Multibulk reply iterator.
     */
    public function __construct(Predis_Iterator_MultiBulkResponseSimple $iterator)
    {
     ...
     * @param Predis_Iterator_MultiBulkResponseSimple $iterator Multibulk reply iterator.
     */
    protected function checkPreconditions(Predis_Iterator_MultiBulkResponseSimple $iterator)
    {
