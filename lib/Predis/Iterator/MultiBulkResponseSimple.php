 ...
 */
class Predis_Iterator_MultiBulkResponseSimple extends Predis_Iterator_MultiBulkResponse
{
    private $connection;
     ...
     */
    public function __construct(Predis_Connection_SingleConnectionInterface $connection, $size)
    {
    ...
    {
        return new Predis_Iterator_MultiBulkResponseTuple($this);
    }
}
