 ...
 */
class Predis_Replication_ReplicationStrategy
{
     ...
     * @return Boolean
     */
    public function isReadOperation(Predis_Command_CommandInterface $command)
    {
        if (isset($this->disallowed[$id = $command->getId()])) {
            throw new Predis_NotSupportedException("The command $id is not allowed in replication mode");
        }
     ...
     * @return Boolean
     */
    public function isDisallowedOperation(Predis_Command_CommandInterface $command)
    {
     ...
     * @return Boolean
     */
    protected function isSortReadOnly(Predis_Command_CommandInterface $command)
    {
