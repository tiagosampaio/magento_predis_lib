 ...
 */
class Predis_Command_Processor_ProcessorChain implements Predis_Command_Processor_CommandProcessorChainInterface, \ArrayAccess
{
     ...
     * {@inheritdoc}
     */
    public function add(Predis_Command_CommandProcessorInterface $processor)
    {
     ...
     * {@inheritdoc}
     */
    public function remove(Predis_Command_CommandProcessorInterface $processor)
    {
    ...
    {
        if (!$processor instanceof Predis_Command_CommandProcessorInterface) {
