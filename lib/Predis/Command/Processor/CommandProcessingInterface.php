 ...
 */
interface Predis_Command_Processor_CommandProcessingInterface
{
    /**
     ...
     */
    public function setProcessor(Predis_Command_Processor_CommandProcessorInterface $processor);
