 ...
 */
class Predis_Pipeline_StandardExecutor implements Predis_Pipeline_PipelineExecutorInterface
{
     ...
     * @return mixed
     */
    protected function onResponseObject(Predis_Connection_ConnectionInterface $connection, CommandInterface $command, ResponseObjectInterface $response)
    {
     ...
     */
    protected function onResponseError(Predis_Connection_ConnectionInterface $connection, ResponseErrorInterface $response)
    {
        if (!$this->exceptions) {
            return $response;
        }
