 ...
 */
class Predis_Pipeline_PipelineContext implements Predis_BasicClientInterface, Predis_ExecutableContextInterface
{
    private $client;
    private $executor;
    private $pipeline;
     ...
     */
    public function __construct(Predis_ClientInterface $client, PipelineExecutorInterface $executor = null)
    {
        $this->client = $client;
     ...
     */
    protected function createExecutor(Predis_ClientInterface $client)
    {
        $options = $client->getOptions();

        if (isset($options->exceptions)) {
            return new Predis_Pipeline_StandardExecutor($options->exceptions);
        }

        return new Predis_Pipeline_StandardExecutor();
    }
     ...
     */
    protected function recordCommand(Predis_Command_CommandInterface $command)
    {
