 ...
 */
class Predis_Cluster_Distribution_HashRing implements Predis_Cluster_Distribution_DistributionStrategyInterface, Predis_Cluster_Hash_HashGeneratorInterface
{
    ...
    private function initialize()
    {
        ...
        if (!$this->nodes) {
            throw new Predis_Cluster_Distribution_EmptyRingException('Cannot initialize empty hashring');
        }
