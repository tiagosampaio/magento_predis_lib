 ...
 */
class Predis_Cluster_PredisClusterHashStrategy implements Predis_Cluster_CommandHashStrategyInterface
{
    private $commands;
     ...
     */
    public function __construct(Predis_Cluster_HashGeneratorInterface $hashGenerator)
    {
     ...
     * @return string
     */
    protected function getKeyFromFirstArgument(Predis_Command_CommandInterface $command)
    {
     ...
     * @return string
     */
    protected function getKeyFromAllArguments(Predis_Command_CommandInterface $command)
    {
     ...
     * @return string
     */
    protected function getKeyFromInterleavedArguments(Predis_Command_CommandInterface $command)
    {
        $arguments = $command->getArguments();
        $keys = array();
     ...
     * @return string
     */
    protected function getKeyFromBlockingListCommands(Predis_Command_CommandInterface $command)
    {
        $arguments = $command->getArguments();
     ...
     * @return string
     */
    protected function getKeyFromBitOp(Predis_Command_CommandInterface $command)
    {
        $arguments = $command->getArguments();
     ...
     * @return string
     */
    protected function getKeyFromZsetAggregationCommands(Predis_Command_CommandInterface $command)
    {
        $arguments = $command->getArguments();
     ...
     * @return string
     */
    protected function getKeyFromScriptingCommands(Predis_Command_CommandInterface $command)
    {
     ...
     * {@inheritdoc}
     */
    public function getHash(Predis_Command_CommandInterface $command)
    {
