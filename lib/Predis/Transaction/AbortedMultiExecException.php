 ...
 */
class Predis_Transaction_AbortedMultiExecException extends Predis_PredisException
{
    private $transaction;
     ...
     */
    public function __construct(Predis_Transaction_MultiExecContext $transaction, $message, $code = null)
    {
