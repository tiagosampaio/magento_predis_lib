 ...
 */
class Predis_Connection_StreamConnection extends Predis_Connection_AbstractConnection
{
    private $mbiterable;
     ...
     * @return resource
     */
    private function tcpStreamInitializer(Predis_Connection_ConnectionParametersInterface $parameters)
    {
     ...
     * @return resource
     */
    private function unixStreamInitializer(Predis_Connection_ConnectionParametersInterface $parameters)
    {
    ...
    public function read()
    {
        ...
        switch ($prefix) {
            ...
            case '*':    // multi bulk
                ...
                if ($this->mbiterable) {
                    return new Predis_Iterator_MultiBulkResponseSimple($this, $count);
                }
