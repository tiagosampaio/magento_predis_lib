 ...
 */
class Predis_Connection_ConnectionFactory implements Predis_Connection_ConnectionFactoryInterface
{
    protected $schemes;
    protected $profile;
    ...
    {
        return array(
            'tcp'  => 'Predis_Connection_StreamConnection',
            'unix' => 'Predis_Connection_StreamConnection',
            'http' => 'Predis_Connection_WebdisConnection',
        );
    }
    ...
    {
        if (!$parameters instanceof Predis_Connection_ConnectionParametersInterface) {
            $parameters = new Predis_Connection_ConnectionParameters($parameters ?: array());
        }
        ...
        if (!$connection instanceof Predis_Connection_SingleConnectionInterface) {
            throw new \InvalidArgumentException(
