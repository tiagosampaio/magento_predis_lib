 ...
 */
class Predis_Connection_ComposableStreamConnection extends Predis_Connection_StreamConnection implements Predis_Connection_ComposableConnectionInterface
{
    private $protocol;
     ...
     */
    public function __construct(Predis_Connection_ConnectionParametersInterface $parameters, ProtocolInterface $protocol = null)
    {
     ...
     * {@inheritdoc}
     */
    public function setProtocol(Predis_Protocol_ProtocolInterface $protocol)
    {
        if ($protocol === null) {
