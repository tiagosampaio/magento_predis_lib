 ...
 */
class Predis_Connection_PhpiredisConnection extends Predis_Connection_AbstractConnection
{
    ...
    private function checkExtensions()
    {
        if (!function_exists('socket_create')) {
            throw new Predis_NotSupportedException(sprintf(self::ERR_MSG_EXTENSION, 'socket'));
        }
     ...
     * @return string
     */
    private function getAddress(Predis_Connection_ConnectionParametersInterface $parameters)
    {
     ...
     * @return string
     */
    private function connectWithTimeout(Predis_Connection_ConnectionParametersInterface $parameters)
    {
