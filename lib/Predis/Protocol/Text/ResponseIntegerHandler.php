 ...
 */
class Predis_Protocol_Text_ResponseIntegerHandler implements Predis_Protocol_ResponseHandlerInterface
{
    /**
     ...
     * @return int
     */
    public function handle(Predis_Connection_ComposableConnectionInterface $connection, $number)
    {
