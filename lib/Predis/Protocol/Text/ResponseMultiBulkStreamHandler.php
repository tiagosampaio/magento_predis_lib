 ...
 */
class Predis_Protocol_Text_ResponseMultiBulkStreamHandler implements Predis_Protocol_ResponseHandlerInterface
{
    /**
     ...
     */
    public function handle(Predis_Connection_ComposableConnectionInterface $connection, $lengthString)
    {
        ...
        return new Predis_Iterator_MultiBulkResponseSimple($connection, $length);
    }
}
