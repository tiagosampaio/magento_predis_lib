 ...
 */
interface Predis_Protocol_ComposableProtocolInterface extends Predis_Protocol_ProtocolInterface
{
    /**
     ...
     */
    public function setReader(Predis_Protocol_ResponseReaderInterface $reader);
