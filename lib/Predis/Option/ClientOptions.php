 ...
 */
class Predis_Option_ClientOptions implements Predis_Option_ClientOptionsInterface
{
    private $handlers;
    private $defined;
    ...
    {
        return array(
            'profile' => new Predis_Option_ClientProfile(),
            'connections' => new Predis_Option_ClientConnectionFactory(),
            'cluster' => new Predis_Option_ClientCluster(),
            'replication' => new Predis_Option_ClientReplication(),
            'prefix' => new Predis_Option_ClientPrefix(),
            'exceptions' => new Predis_Option_ClientExceptions(),
        );
    }
    ...
    public function __get($option)
    {
        ...
        if (isset($this->handlers[$option])) {
            ...
            $value = $handler instanceof Predis_Option_OptionInterface ? $handler->getDefault($this) : $handler($this);
            $this->options[$option] = $value;
    ...
    {
        if ($option instanceof Predis_Options_OptionInterface) {
