 ...
 */
class Predis_Option_ClientConnectionFactory extends Predis_Option_AbstractOption
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if ($value instanceof Predis_Option_ConnectionFactoryInterface) {
            return $value;
        }
        ...
        if (is_callable($value)) {
            ...
            if (!$factory instanceof Predis_Option_ConnectionFactoryInterface) {
    ...
    {
        return new Predis_Connection_ConnectionFactory($options->profile);
    }
}
