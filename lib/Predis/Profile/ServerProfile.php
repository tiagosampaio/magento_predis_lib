 ...
 */
abstract class Predis_Profile_ServerProfile implements Predis_Profile_ServerProfileInterface, Predis_Command_Processor_CommandProcessingInterface
{
    ...
    {
        return array(
            '1.2'     => 'Predis_Profile_ServerVersion12',
            '2.0'     => 'Predis_Profile_ServerVersion20',
            '2.2'     => 'Predis_Profile_ServerVersion22',
            '2.4'     => 'Predis_Profile_ServerVersion24',
            '2.6'     => 'Predis_Profile_ServerVersion26',
            'default' => 'Predis_Profile_ServerVersion26',
            'dev'     => 'Predis_Profile_ServerVersionNext',
        );
    }
    ...
    public static function define($alias, $profileClass)
    {
        ...
        if (!$profileReflection->isSubclassOf('Predis_Profile_ServerProfileInterface')) {
     ...
     * {@inheritdoc}
     */
    public function setProcessor(Predis_Command_Processor_CommandProcessorInterface $processor = null)
    {
